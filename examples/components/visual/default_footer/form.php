...
?>
 ...
 <form id="default_footer">
	<div class="card-body">
        ...
        <button id="visibility-dialog" visibility-dialog visibility-values='<?php echo json_encode($component_data['visibility_conditions'])?>' class="btn btn-icon btn-warning btn-xs mr-2"><i class="fas fa-pen"></i></button>
