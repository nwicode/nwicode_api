...
<div id="page_footer_0315">
    <ion-footer <?php if ($no_border) echo 'class="ion-no-border"';?>>
		<ion-toolbar style="text-align: <?php echo $text_align;?>;" color="<?php echo $background_color_value;?>">
			...
			<?php }?>
			<ion-title><ion-text style="font-size: <?php echo $font_size;?>px;" color="<?php echo $text_color_value?>">{{translationService.translatePhrase('PAGE_<?php echo $component_data['page_id']?>_<?php echo $component_data['page_component_id']?>_FOOTER_TITLE')}}</ion-text></ion-title>
			...
			<?php if ($use_right_button) {?>
				...
				<?php if ($right_button_icon!="" && $rbtext!="") {?> 
					<ion-icon color="<?php echo $right_button_icon_color_value?>" slot="end" name="<?php echo $right_button_icon; ?>"></ion-icon><ion-text color="<?php echo $right_button_text_color_value?>">{{translationService.translatePhrase('PAGE_<?php echo $component_data['page_id']?>_<?php echo $component_data['page_component_id']?>_FOOTER_RB_TITLE')}}</ion-text>
