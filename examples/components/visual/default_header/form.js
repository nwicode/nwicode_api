...
function component_init_form(form_data,component_data,page_data) {
	console.log("default_header component_init_form fired!");
...
function component_data_changed(form_data,component_data,page_data) {
	console.log("default_header component_data_changed fired!");
	console.log("form_data:");
	console.log(form_data);
	console.log("component_data:");
	console.log(component_data);
...
function color_selected(button, color_result) {
	...
	if (!jQuery.isEmptyObject(color_result)) {
		console.log("default_header color_selected fired!");
		console.log("button");
		console.log(button);
...
function icon_selected(button, icon_result) {
		...
		console.log("default_header icon_selected fired!");
		console.log("button");
		console.log(button);
...
function strings_inputted(button, result) {
	...
	if (!jQuery.isEmptyObject(result)) {
		console.log("default_header texts_inputted fired!");
		console.log("button");
		console.log(button);
		console.log("result");
		console.log(result);
		...
		if (button.id=="title-button") {
			for (let lng in result) { 
				$("input[name='TRANSLATIONS["+lng+"][HEADER_TITLE]']").val(result[lng]);
				$("#TRANSLATIONS_"+lng+"_HEADER_TITLE").html(result[lng]);
		...
		if (button.id=="rb-title-button") {
			for (let lng in result) { 
				$("input[name='TRANSLATIONS["+lng+"][HEADER_RB_TITLE]']").val(result[lng]);
				$("#TRANSLATIONS_"+lng+"_HEADER_RB_TITLE").html(result[lng]);
		...
		if (button.id=="lb-title-button") {
			for (let lng in result) { 
				$("input[name='TRANSLATIONS["+lng+"][HEADER_LB_TITLE]']").val(result[lng]);
				$("#TRANSLATIONS_"+lng+"_HEADER_LB_TITLE").html(result[lng]);
