...
?>
 ...
 <form id="default_footer">
	<div class="card-body">
		<div class="row">
			<div class="col-sm-12"><div class="h3">Header settings</div></div>
		</div>
		<div class="row">
			...
			<div class="d-flex align-items-center mb-9 rounded p-2 pl-5 pr-5 color-block" style="background-color: <?php echo $background_color_value;?>">
				...
				<div class="d-flex flex-column flex-grow-1 mr-2">
					<?php foreach($aplication_translations as $aplication_translation) { ?>
						<span  class="font-weight-bold font-size-lg mb-1 text-color-block" style="color: <?php echo $text_color_value;?>"><?php echo $aplication_translation->code?>: <span id="TRANSLATIONS_<?php echo $aplication_translation->code?>_HEADER_TITLE"><?php echo $langs[$aplication_translation->code]['HEADER_TITLE']?></span></span>
					<input type="hidden" name="TRANSLATIONS[<?php echo $aplication_translation->code?>][HEADER_TITLE]" value="<?php echo $langs[$aplication_translation->code]['HEADER_TITLE']?>"  />
					<?php } ?>
				</div>
		...
		<div class="form-group" id="lb-color-block">
			...
			<div class="d-flex align-items-center mb-9 rounded p-2 pl-5 pr-5 color-block" style="background-color: <?php echo $left_button_color_value;?>">
				...
				<div class="d-flex flex-column flex-grow-1 mr-2">
					<?php foreach($aplication_translations as $aplication_translation) { ?>
					<span  class="font-weight-bold font-size-lg mb-1 text-color-block" style="color: <?php echo $left_button_text_color_value;?>"><?php echo $aplication_translation->code?>: <span id="TRANSLATIONS_<?php echo $aplication_translation->code?>_HEADER_LB_TITLE"><?php echo $langs[$aplication_translation->code]['HEADER_LB_TITLE']?></span></span>
					<input type="hidden" name="TRANSLATIONS[<?php echo $aplication_translation->code?>][HEADER_LB_TITLE]" value="<?php echo $langs[$aplication_translation->code]['HEADER_LB_TITLE']?>"  />
				<?php } ?>
				</div>
		...
		<div class="form-group" id="rb-color-block">
			...
			<div class="d-flex align-items-center mb-9 rounded p-2 pl-5 pr-5 color-block" style="background-color: <?php echo $right_button_color_value;?>">
				...
				<div class="d-flex flex-column flex-grow-1 mr-2">
					<?php foreach($aplication_translations as $aplication_translation) { ?>
					<span  class="font-weight-bold font-size-lg mb-1 text-color-block" style="color: <?php echo $right_button_text_color_value;?>"><?php echo $aplication_translation->code?>: <span id="TRANSLATIONS_<?php echo $aplication_translation->code?>_HEADER_RB_TITLE"><?php echo $langs[$aplication_translation->code]['HEADER_RB_TITLE']?></span></span>
					<input type="hidden" name="TRANSLATIONS[<?php echo $aplication_translation->code?>][HEADER_RB_TITLE]" value="<?php echo $langs[$aplication_translation->code]['HEADER_RB_TITLE']?>"  />
				<?php } ?>
				</div>
